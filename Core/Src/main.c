...
int main(void)
{
  ...
  timing_params.vbp = 4;
  timing_params.hfp = 38;
  timing_params.vfp = 8; // Change these if does not work


  ST7789V_InitParams_t init_params;
  init_params.ColorCoding = ST7789V_FORMAT_DEFAULT;
  init_params.Endian = ST7789V_ENDIAN_BIG;
  init_params.Orientation = ST7789V_ORIENTATION_LANDSCAPE;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ST7789V_DC_Pin|ST7789V_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ST7789V_RST_GPIO_Port, ST7789V_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ST7789V_DC_Pin ST7789V_CS_Pin */
  GPIO_InitStruct.Pin = ST7789V_DC_Pin|ST7789V_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : ST7789V_RST_Pin */
  GPIO_InitStruct.Pin = ST7789V_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ST7789V_RST_GPIO_Port, &GPIO_InitStruct);
